...
def deletefaredetailuserwin():
    def adam():
        ...
        if conad:
            cursor = conad.cursor()
            qry = "DELETE from starmoversdb.faredetail WHERE (id = %s)"
    ...
    Button(root, text="Delete", command=adam, height=2, width=10).place(x=10, y=190)
    root.mainloop()
